...
-- Contiene la lógica matematica de algunas funciones secuenciales.
-- Se definen los tipos importantes: DistributionValues, Frequency, y MedidaPol siendo para las funciones de polarización.
-- Contiene la función min_p que implementa un algoritmo de busqeuda recursiva pura para encontrar
